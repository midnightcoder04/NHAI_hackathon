...
CREATE TABLE IF NOT EXISTS personnel (
  ...
  sync_error    TEXT,
  -- T077: soft-delete marker. A delete of an unsynced / mid-sync record sets this to 1
  -- (tombstone) instead of removing the row, and the UI filters tombstoned records out.
